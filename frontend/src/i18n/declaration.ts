...
export enum I18nKey {
  ...
  SETTINGS$LITELLM_PROXY = "SETTINGS$LITELLM_PROXY",
  SETTINGS$USING_LITELLM_PROXY = "SETTINGS$USING_LITELLM_PROXY",
  SETTINGS$ENABLE_LITELLM_PROXY = "SETTINGS$ENABLE_LITELLM_PROXY",
  SETTINGS$LITELLM_PROXY_URL = "SETTINGS$LITELLM_PROXY_URL",
  SETTINGS$LITELLM_PROXY_API_KEY = "SETTINGS$LITELLM_PROXY_API_KEY",
